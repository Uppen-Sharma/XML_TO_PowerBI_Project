...
export default function Login() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-dashboard">
        ...
        <div className="w-full max-w-[430px]">
          <div className="rounded-2xl border border-[#DCE1EA] bg-white/95 px-7 py-8 shadow-[0_24px_60px_rgba(0,27,77,0.28)] backdrop-blur-[2px] sm:px-9 sm:py-9">
            <div className="flex flex-col items-center justify-center gap-2 mb-6 text-center">
              <h1 className="text-[clamp(1rem,1.4vw,1.25rem)] font-black text-[#0b132b] leading-snug whitespace-nowrap">
                Welcome to the PBI Accelerator
              </h1>
            </div>
            <div className="my-4 h-px bg-[#E5E8EF]" />
            <div className="flex justify-center">
              <img src="/logo.png" alt="SRM" className="h-8 w-auto object-contain" />
            </div>
            ...
            <form onSubmit={handleLogin}>
              <button
                type="submit"
                className="group flex h-12 w-full items-center justify-center gap-3 rounded-md bg-primary px-4 font-medium text-[clamp(0.85rem,1.15vw,1rem)] text-white transition-all duration-200 hover:bg-primary-hover focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/45 focus-visible:ring-offset-2"
              >
