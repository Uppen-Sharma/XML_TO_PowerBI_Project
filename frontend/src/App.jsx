...
function App() {
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-slate-50 to-indigo-50 flex flex-col items-center py-12 px-4 sm:px-6 lg:px-8"
      style={{ fontFamily: "var(--sans)" }}
    >
      <div className="max-w-3xl w-full space-y-8">
        <div className="text-center">
          <div className="mx-auto h-16 w-16 bg-indigo-600 rounded-2xl flex items-center justify-center shadow-lg transform rotate-3 hover:rotate-6 transition-transform">
          ...
          <div className="p-8 sm:p-10">
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center gap-4 justify-center">
              <button
                ...
                className={`w-full sm:w-auto px-8 py-3.5 rounded-xl font-semibold text-white shadow-sm
              ...
              {downloadInfo && (
                <a
                  ...
                  className="w-full sm:w-auto px-8 py-3.5 rounded-xl font-semibold text-indigo-700
                    bg-indigo-50 hover:bg-indigo-100 transition-all flex items-center justify-center
                    space-x-2 border border-indigo-200 hover:shadow-sm"
                >
